...
const BASE_IMG = './public/img/Cardapio/Products';
...
$drinks = [
  ...
  [
    'imageUrl' => BASE_IMG . 'Bebidas/veuve clicquot.jpg',
    'name' => 'Veuve Clicquot',
    'price' => 89.99,
    'category' => 'Bebida',
  ]
...
$desserts = [
  [
    'imageUrl' => BASE_IMG . 'Sobremesas/buches noel.jpg',
    'name' => 'Bûches Noël',
    'price' => 12.99,
    'category' => 'Sobremesa',
  ],
  [
    'imageUrl' => BASE_IMG . 'Sobremesas/creme brulee.jpg',
    'name' => 'Crème Brûlée',
    'price' => 8.99,
    'category' => 'Sobremesa',
  ],
...
$mainDishes = [
  ...
  [
    'imageUrl' => BASE_IMG . 'Pratos Principais/macarraojpg',
    'name' => 'Macarrão Parisiense',
    'price' => 10.99,
    'category' => 'Prato Principal',
  ]
];
...
$sideDishes = [
  [
    'imageUrl' => BASE_IMG . 'Acompanhamentos/croissant.jpg',
    'name' => 'Croissant',
    'price' => 3.75,
    'category' => 'Acompanhamento',
  ],
  [
    'imageUrl' => BASE_IMG . 'Acompanhamentos/ovos.jpg',
    'name' => 'Ovos Mimosa',
    'price' => 6.99,
    'category' => 'Acompanhamento',
  ],
